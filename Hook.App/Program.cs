...
namespace Hook.App
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            builder.RegisterType<ProcessArguments>();
            Container = builder.Build();
            var scope = Container.BeginLifetimeScope();
            var db = scope.Resolve<IData>();
            var common = scope.Resolve<Common>();
            var processArguments = scope.Resolve<ProcessArguments>();
            ...
            else
            {
                ...
                WorkItem entry = processArguments.Process_args(args, mode);

                //Conditional to select the operation to perform
